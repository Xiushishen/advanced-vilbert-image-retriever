...
def main():
    ...
    if args.lr_scheduler == "warmup_linear":
        warmup_scheduler = get_scheduler(
            "linear", optimizer, num_warmup_steps=warmpu_steps, num_training_steps=num_train_optimization_steps
        )
    else:
        warmup_scheduler = get_scheduler(
            "constant", optimizer, num_warmup_steps=warmpu_steps, num_training_steps=num_train_optimization_steps
        )
